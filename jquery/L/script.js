jQuery(function($){
	...
	$("#append").on("click", function(){
		...
		$("<li>花子</li>").appendTo("#add ul");
	});
	$("#prepend").on("click", function(){
		// $("#add ul").prepend("<li>太郎</li>");
		$("<li>太郎</li>").prependTo("#add ul");
	});
	$("#before").on("click", function(){
		// $("#add ul").before("<p>子供の名前</p>");
		$("<p>子供の名前</p>").insertBefore("#add ul");
	});
	$("#after").on("click", function(){
		// $("#add ul").after("<p>生年月日</p>");
		$("<p>生年月日</p>").insertAfter("#add ul");
	});
	...
	$("#set-attr").on("click", function(){
		$("#apple")
			.attr("href", "http://www.apple.com/ph");
	});
